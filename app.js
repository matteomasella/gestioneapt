...
<head>
    ...
    <style>
        :root {
            --ottanio: #004D54;
            --carta-da-zucchero: #BFEBFF;
            --magenta: #DB4F61;
            --verde: #54C4A6;
            --bianco: #FFFFFF;
            --nero: #000000;
            --light-magenta: #F5C9D1;
            --light-green: #CCEDE5;
        }
        body {
        ...
        .btn-category {
            background-color: var(--carta-da-zucchero);
            color: var(--ottanio);
        }
        .btn-suggestion {
...
<body class="bg-ottanio">
    ...
    <div id="app-container" class="max-w-md mx-auto bg-ottanio min-h-screen">

        <div id="welcome" class="page active p-6">
            <div class="flex justify-end mb-4">
                <button class="lang-btn active" data-lang="it">IT</button>
                <button class="lang-btn ml-2" data-lang="en">EN</button>
            </div>
            <header class="text-center mb-10">
                <div class="flex justify-center items-center gap-4 mb-2">
                    <div id="logo-container"></div>
                    <h1 class="text-3xl font-bold" style="color: var(--carta-da-zucchero);" id="welcome-title"></h1>
                </div>
                <p style="color: var(--carta-da-zucchero);" class="opacity-80" id="welcome-subtitle"></p>
            </header>
            <main class="space-y-4" id="welcome-buttons">
                <button onclick="loadGuide('ristoranti')" class="w-full btn-category font-bold py-5 rounded-lg shadow-md text-lg" id="btn-ristoranti"></button>
                <button onclick="loadGuide('settembre')" class="w-full btn-category font-bold py-5 rounded-lg shadow-md text-lg" id="btn-settembre"></button>
                <button onclick="loadGuide('nolo')" class="w-full btn-category font-bold py-5 rounded-lg shadow-md text-lg" id="btn-nolo"></button>
            </main>
        </div>

        <div id="guide-content" class="page"></div>
    ...
    <script>
        ...
        function showPage(pageId) {
            ...
            const backButtonText = currentGuide === 'nolo' ? "← Torna a NoLo" : "← Torna alla Home";
